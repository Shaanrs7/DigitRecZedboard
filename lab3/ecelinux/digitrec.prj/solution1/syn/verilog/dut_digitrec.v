...
wire   [3:0] i_8_fu_169_p2;
reg   [3:0] i_8_reg_271;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_51;
wire   [5:0] tmp_28_fu_187_p2;
reg   [5:0] tmp_28_reg_276;
wire   [0:0] exitcond12_fu_163_p2;
wire   [1:0] k_4_fu_199_p2;
reg    ap_sig_cseq_ST_st3_fsm_2;
reg    ap_sig_66;
wire   [10:0] i_9_fu_225_p2;
reg   [10:0] i_9_reg_292;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_75;
wire   [14:0] tmp_cast_20_fu_231_p1;
reg   [14:0] tmp_cast_20_reg_297;
wire   [0:0] exitcond13_fu_219_p2;
wire   [3:0] j_3_fu_241_p2;
reg   [3:0] j_3_reg_305;
...
wire  signed [63:0] tmp_33_cast_fu_214_p1;
wire   [63:0] tmp_35_cast_fu_258_p1;
wire   [5:0] tmp_s_fu_179_p3;
wire   [5:0] tmp_cast_fu_175_p1;
wire   [5:0] tmp_23_cast_fu_205_p1;
wire   [5:0] tmp_29_fu_209_p2;
wire   [14:0] tmp_30_fu_253_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond13_fu_219_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(exitcond12_fu_163_p2 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & ~(1'b0 == exitcond14_fu_193_p2))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond13_fu_219_p2))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & (1'b0 == exitcond14_fu_193_p2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond13_fu_219_p2))) begin
        tmp_cast_20_reg_297[10 : 0] <= tmp_cast_20_fu_231_p1[10 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        knn_set_V_address0 = tmp_33_cast_fu_214_p1;
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if ((exitcond12_fu_163_p2 == 1'b0)) begin
        ...
        ap_ST_st3_fsm_2 : begin
            if ((1'b0 == exitcond14_fu_193_p2)) begin
                ap_NS_fsm = ap_ST_st3_fsm_2;
            end else begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end
        ...
        ap_ST_st4_fsm_3 : begin
            if ((1'b0 == exitcond13_fu_219_p2)) begin
...
assign exitcond12_fu_163_p2 = ((i_reg_92 == ap_const_lv4_A) ? 1'b1 : 1'b0);

assign exitcond13_fu_219_p2 = ((i4_reg_114 == ap_const_lv11_708) ? 1'b1 : 1'b0);

assign exitcond14_fu_193_p2 = ((k_reg_103 == ap_const_lv2_3) ? 1'b1 : 1'b0);
...
assign i_8_fu_169_p2 = (i_reg_92 + ap_const_lv4_1);

assign i_9_fu_225_p2 = (i4_reg_114 + ap_const_lv11_1);

assign j_3_fu_241_p2 = (j_reg_125 + ap_const_lv4_1);

assign k_4_fu_199_p2 = (k_reg_103 + ap_const_lv2_1);

assign next_mul_fu_247_p2 = (phi_mul_reg_137 + ap_const_lv15_708);

assign tmp_23_cast_fu_205_p1 = k_reg_103;

assign tmp_28_fu_187_p2 = (tmp_s_fu_179_p3 - tmp_cast_fu_175_p1);

assign tmp_29_fu_209_p2 = (tmp_28_reg_276 + tmp_23_cast_fu_205_p1);

assign tmp_30_fu_253_p2 = (phi_mul_reg_137 + tmp_cast_20_reg_297);

assign tmp_33_cast_fu_214_p1 = $signed(tmp_29_fu_209_p2);

assign tmp_35_cast_fu_258_p1 = tmp_30_fu_253_p2;

assign tmp_cast_20_fu_231_p1 = i4_reg_114;

assign tmp_cast_fu_175_p1 = i_reg_92;

assign tmp_s_fu_179_p3 = {{i_reg_92}, {ap_const_lv2_0}};

assign training_data_V_address0 = tmp_35_cast_fu_258_p1;

always @ (posedge ap_clk) begin
    tmp_cast_20_reg_297[14:11] <= 4'b0000;
end
